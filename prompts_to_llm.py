...
def generate_questions_prompt(mock_test_type):
    if mock_test_type == "Multiple-choice":
        text_prompt = (
            ...
            "exam:\n\n"
            "1. Generate the Multiple choice questions with 4 options from the adjacent topics given here with the "
            "inflated difficulty than the one provided."
            "2. Make sure that the questions can test the in-depth understanding of the student."
            "3. Make sure that questions are not direct but requires understanding of the subject"
            "4. Ensure to properly display questions and not as html tags. use markdown formatting."
            "5. Do not display topic names and difficulty of generated questions."
        ...
        text_prompt = (
            "Please perform the following tasks by using the content provided and knowing that it is a competitive "
            "exam:\n\n"
            "1. Generate the Descriptive and Numerical questions from the adjacent topics given here with the "
            "inflated difficulty than the one provided."
            "2. Make sure that the questions can test the in-depth understanding of the student."
            "3. Make sure that questions are not direct but requires understanding of the subject"
            "4. Ensure to properly display questions and not as html tags. use markdown formatting."
            ...
            "Make sure that you do not give any additional explanation, answers, notes, suggestions, advices etc and "
            "give"
            "the answer straight to the point as asked. Title it is Mock Test"
        )
